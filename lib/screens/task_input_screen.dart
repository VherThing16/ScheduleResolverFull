        ...
        return Theme(
          data: Theme.of(context).copyWith(
            timePickerTheme: TimePickerThemeData(
              ...
              hourMinuteColor: const Color(0xFFFFF5E6),
              hourMinuteTextColor: Colors.black,
              dialBackgroundColor: const Color(0xFFFFF5E6),
              dialHandColor: const Color(0xFFE67E5A),
              dialTextColor: Colors.black,
              entryModeIconColor: const Color(0xFFE67E5A),
            ),
          ),
          child: child!,
        );
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                icon: const Icon(Icons.expand_more, color: Colors.black54, size: 18),
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Start', style: GoogleFonts.dmSans(fontSize: 10, color: Colors.black54)),
                            const SizedBox(height: 2),
                            Text(
                              _startTime.format(context),
                              style: GoogleFonts.dmSans(fontSize: 15, fontWeight: FontWeight.w500, color: const Color(0xFFE67E5A)),
                            ),
                          ],
                        ),
                      ),
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('End', style: GoogleFonts.dmSans(fontSize: 10, color: Colors.black54)),
                            const SizedBox(height: 2),
                            Text(
                              _endTime.format(context),
                              style: GoogleFonts.dmSans(fontSize: 15, fontWeight: FontWeight.w500, color: Colors.black),
                            ),
                          ],
                        ),
                      ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.dmSans(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFFE67E5A)),
                  ),
                ],
              ),
              Slider(
                  ...
                  return Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: selected ? const Color(0xFFE67E5A).withOpacity(0.12) : const Color(0xFFFFF8F0),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: selected ? const Color(0xFFE67E5A) : const Color(0xFFE8D5B5),
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.dmSans(
                            ...
                            color: selected ? const Color(0xFFE67E5A) : Colors.black54,
                          ),
                        ),
                      ),
                    ),
