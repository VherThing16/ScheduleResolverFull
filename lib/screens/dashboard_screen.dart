...
class DashboardScreen extends StatelessWidget {
  ...
  Color _categoryColor(String category) {
    switch (category) {
      case 'Class':    return const Color(0xFFE67E5A);
      case 'Study':    return const Color(0xFFD4845F);
      case 'Org Work': return const Color(0xFFC78D6B);
      case 'Rest':     return const Color(0xFF2E8B78);
      default:         return const Color(0xFFE67E5A);
    }
  }
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isCompleted
                            ...
                            : const Color(0xFFE67E5A).withOpacity(0.12),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: isCompleted ? const Color(0xFFE8D5B5) : const Color(0xFFE67E5A),
                          width: 1,
                        ),
                      ),
                      child: Text(isCompleted ? 'Mark Undone' : 'Mark Done',
                          ...
                          style: GoogleFonts.dmSans(fontSize: 13, fontWeight: FontWeight.w600,
                              color: isCompleted ? Colors.black54 : const Color(0xFFE67E5A))),
                    ),
                  ),
                ),
  ...
  Widget _detailRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: GoogleFonts.dmSans(fontSize: 13, color: Colors.black54)),
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('This will permanently remove all tasks from your timeline.',
            style: GoogleFonts.dmSans(fontSize: 13, color: Colors.black54, height: 1.5)),
        actions: [
          TextButton(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        ...
                        valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFFE67E5A)),
                      ),
                    ),
            ...
            if (aiService.currentAnalysis != null) ...[
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFFFF8F0),
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(color: const Color(0xFFE67E5A).withOpacity(0.35), width: 1),
                ),
                child: Row(children: [
                  Container(width: 6, height: 6,
                      decoration: const BoxDecoration(color: Color(0xFFE67E5A), shape: BoxShape.circle)),
                  const SizedBox(width: 10),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: const Color(0xFFE67E5A), borderRadius: BorderRadius.circular(20)),
                      child: Text('View',
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: isDone
                                    ? const Color(0xFF2E8B78).withOpacity(0.15)
                                    : Colors.transparent,
                                border: Border.all(
                                  color: isDone
                              ...
                              child: isDone
                                  ? const Icon(Icons.check, size: 12, color: Color(0xFF2E8B78))
                                  : null,
                            ),
                          ),
                          const SizedBox(width: 12),
                                  ...
                                  Text(task.title,
                                      style: GoogleFonts.dmSans(
                                        ...
                                        decoration: isDone
                                            ...
                                            : TextDecoration.none,
                                        decorationColor: const Color(0xFF2E8B78),
                                      )),
                    ...
                    child: ElevatedButton(
                      ...
                      child: aiService.isLoading
                          ...
                          child: CircularProgressIndicator(
                              strokeWidth: 2, color: Color(0xFFE67E5A)))
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color(0xFFFAF6F0), width: 2),
                        ),
                        child: Text(
